...
import { __extends as n, __assign as i, __spreadArrays as e, __awaiter as r, __generator as u } from "tslib";
...
import { XhrIo as m, EventType as g, ErrorCode as b, createWebChannelTransport as p, WebChannel as y } from "@firebase/webchannel-wrapper";
 ...
 */ var ct = /** @class */ function() {
    ...
    return n(i, t), i.prototype.K = function(t, n, e) {
        return new i(t, n, e);
...
function li() {
    return fi.logLevel === o.DEBUG ? 0 /* DEBUG */ : fi.logLevel === o.SILENT ? 2 /* SILENT */ : 1 /* ERROR */;
}
...
function vi(t, n) {
    ...
    if (fi.logLevel <= o.DEBUG) {
        var u = i.map(mi);
        fi.debug.apply(fi, e([ "Firestore (" + _ + ") [" + t + "]: " + n ], u));
    }
}

function wi(t) {
    for (var n = [], i = 1; i < arguments.length; i++) n[i - 1] = arguments[i];
    if (fi.logLevel <= o.ERROR) {
        var r = n.map(mi);
        fi.error.apply(fi, e([ "Firestore (" + _ + "): " + t ], r));
    }
}
 ...
 */ var le = /** @class */ function() {
    ...
    t.Fc = /** @class */ function(t) {
        ...
        return n(i, t), i.prototype.qs = function(t) {
            var n = this, i = [];
    ...
    return n(i, t), i.prototype.Ba = function(t) {
    ...
    return n(i, t), Object.defineProperty(i.prototype, "Ka", {
        /**
 ...
 */
        return function(t) {
            ...
            try {
                return new (De.bind.apply(De, e([ void 0 ], t.split("."))));
            } catch (n) {
    ...
    t.prototype._l = function(t) {
        ...
        return r(this, void 0, void 0, (function() {
            ...
            return u(this, (function(i) {
                ...
                // Graceful stop (due to stop() or idle timeout). Make sure that's
                // desirable.
                bi(!this.Il(), "Write stream was stopped gracefully while still needed."), t && this.Kf.length > 0 ? (void 0, 
                [ 2 /*return*/ , (this.ul.Ka ? this.Rl(t) : this.Sl(t)).then((function() {
...
var Rr = k(ar, "Use firebase.firestore() instead."), Sr = k(fr, "Use firebase.firestore().runTransaction() instead."), Ar = k(lr, "Use firebase.firestore().batch() instead."), Cr = k(dr, "Use firebase.firestore().doc() instead."), Pr = k(wr), kr = k(mr), Nr = k(gr), Or = k(br), Fr = k(pr, "Use firebase.firestore().collection() instead."), Vr = /** @class */ function() {
    function t(n) {
        ...
        // log on 12.2.
        12.2 === t.iw(h()) && wi("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /**
    ...
    t.ph = function() {
        ...
        // Check the UA string to find out the browser.
                var n = h(), i = t.iw(n), e = 0 < i && i < 10, r = t.uw(n), u = 0 < r && r < 4.5;
        // IE 10
...
var _u = [ hu.store, cu.store, au.store, du.store, wu.store, ou.store, gu.store, mu.store ], Iu = e(_u, [ yu.store ]), Tu = e(Iu, [ vu.store ]), Eu = e(Tu, [ bu.store ]), Du = /** @class */ function() {
    function t() {
        /**
...
var ju = /** @class */ function() {
     ...
     */    return t.prototype.Jm = function(t, n) {
        ...
        return new Promise((function(s, o) {
            var h = new m;
            h.listenOnce(g.COMPLETE, (function() {
                try {
        ...
        var i = [ this.Hm, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], e = p(), r = {
