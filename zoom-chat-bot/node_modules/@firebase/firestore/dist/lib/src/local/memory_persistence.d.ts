...
import { GarbageCollectionScheduler, Persistence, PersistenceProvider, PersistenceTransaction, PersistenceTransactionMode, PrimaryStateListener, ReferenceDelegate } from './persistence';
...
export declare class MemoryPersistenceProvider implements PersistenceProvider {
    private clientId;
    initialize(asyncQueue: AsyncQueue, databaseInfo: DatabaseInfo, platform: Platform, clientId: ClientId, initialUser: User, settings: PersistenceSettings): Promise<void>;
